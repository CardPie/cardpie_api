        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDailyRemind = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    WeeklyReminderDays = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpacedRepetitionStrategyLevel = table.Column<int>(type: "int", nullable: false, defaultValue: 2),
                    FolderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValue: new Guid("00000000-0000-0000-0000-000000000000")),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrontDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FrontSoundUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BackDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BackSoundUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardsStudied = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Avatar = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "https://i.pinimg.com/564x/76/68/4a/76684ac1fccf120998c15dcc094a07ad.jpg"),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    ActivePremiumDate = table.Column<DateTime>(type: "datetime2", nullable: true),
